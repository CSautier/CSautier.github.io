...
!function(a) {
    ...
    function g(a, b) {
        ...
        T.extend(P, a),
        delete P.fixLng,
        P.functions && (delete P.functions,
        T.extend(T, a.functions)),
        "string" == typeof P.ns && (P.ns = {
            namespaces: [P.ns],
            defaultNs: P.ns
        }),
        "string" == typeof P.fallbackNS && (P.fallbackNS = [P.fallbackNS]),
        ("string" == typeof P.fallbackLng || "boolean" == typeof P.fallbackLng) && (P.fallbackLng = [P.fallbackLng]),
    ...
    function i(a, b, c, d) {
        "string" != typeof b ? (c = b,
        b = P.ns.defaultNs) : P.ns.namespaces.indexOf(b) < 0 && P.ns.namespaces.push(b),
        K[a] = K[a] || {},
        K[a][b] = K[a][b] || {},
    ...
    function j(a, b) {
        ...
        var c = K[a][b] || {}
          , d = !1;
        for (var e in c)
            c.hasOwnProperty(e) && (d = !0);
        return d
    }
    function k(a, b) {
        return "string" != typeof b && (b = P.ns.defaultNs),
        K[a] = K[a] || {},
        T.extend({}, K[a][b])
    }
    function l(a, b) {
        ...
        j.length ? J.sync._fetch(j, c, function(c, d) {
            ...
            T.each(a, function(a, c) {
                ...
                T.each(j, function(a, f) {
                    ...
                    K[f][c] = d[f][c],
                    e--,
                    0 === e && b && (P.useLocalStorage && J.sync._storeLocal(K),
                    b())
                })
            })
        }) : b && b()
    ...
    function v(a, b, c, d) {
        ...
        a.indexOf(d.interpolationPrefix || P.interpolationPrefix) < 0)
            return a;
        var e = d.interpolationPrefix ? T.regexEscape(d.interpolationPrefix) : P.interpolationPrefixEscaped
          , f = d.interpolationSuffix ? T.regexEscape(d.interpolationSuffix) : P.interpolationSuffixEscaped
          , g = "HTML" + f
    ...
    function w(a, b) {
        var c = ","
          ...
          , e = "}"
          , f = T.extend({}, b);
        for (delete f.postProcess; -1 != a.indexOf(P.reusePrefix) && (L++,
        !(L > P.maxRecursion)); ) {
    ...
    function B(a, b) {
        return b = b || {},
        N ? (L = 0,
        E.apply(null, arguments)) : (T.log("i18next not finished initialization. you might have called t function before loading resources finished."),
        b.defaultValue || "")
    }
    function C(a, b) {
    ...
    function E(a, b) {
        ...
        c.indexOf(P.nsseparator) > -1 && (e = c.split(P.nsseparator),
        i = e[0],
        c = e[1]),
        ...
        var k = f;
        if (f.indexOf(P.nsseparator) > -1 && (e = f.split(P.nsseparator),
        k = e[1]),
    ...
    function F(a, b) {
        ...
        if ("cimode" === f[0].toLowerCase())
            return e;
        if (b.lngs && (f = b.lngs),
        b.lng && (f = T.toLanguages(b.lng, b.fallbackLng),
        !K[f[0]])) {
            var g = P.getAsync;
            P.getAsync = !1,
                ...
                if ("string" == typeof A)
                    ...
                    if (null === A && P.fallbackOnNull === !0)
                        ...
                        if (P.returnObjectTrees || b.returnObjectTrees) {
                            ...
                            P.objectTreeKeyHandler && "function" == typeof P.objectTreeKeyHandler ? A = P.objectTreeKeyHandler(a, A, t, h, b) : (A = "key '" + h + ":" + a + " (" + t + ")' returned an object instead of string.",
                            T.log(A))
                } else
                    A = A.join("\n"),
                    A = v(A, b),
        ...
        if (void 0 === p && !b.isFallbackLookup && (P.fallbackToDefaultNS === !0 || P.fallbackNS && P.fallbackNS.length > 0)) {
            ...
            P.fallbackNS.length) {
                for (var H = 0, I = P.fallbackNS.length; I > H; H++)
                    if (p = F(P.fallbackNS[H] + P.nsseparator + a, b),
    ...
    O = {
        ...
        postMissing: function(a, b, c, d, e) {
            ...
            else if ("current" === P.sendMissingTo || "fallback" === P.sendMissingTo && P.fallbackLng[0] === !1)
                g.push({
                    lng: a,
                    url: v(P.resPostPath, {
                        lng: a,
        ...
        toLanguages: function(a) {
            function b(a) {
                ...
                if ("string" == typeof a && a.indexOf("-") > -1) {
                    ...
                    b = P.lowerCaseLng ? a.toLowerCase() : a;
                return b
            }
            var c = this.log
              , d = []
